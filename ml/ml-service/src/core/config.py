...
class MLSettings(BaseSettings):
    PROJECT_NAME: str = "StadiumOS-ML-Prediction-Service"
    ...
    # DB Configurations (For prediction logs caching)
    ...
    MODEL_REGISTRY_PATH: str = os.getenv("STADIUMOS_MODEL_REGISTRY_PATH", "/workspace/ml/models")
